...
The extension is versioned with the snapshot contract and supports the Fantasy Grounds Unity `5E` ruleset. Version 1.1 exports loaded class, subclass, species/race, feat, and background records; player characters; prepared encounters; live Combat Tracker state; and a deduplicated journal of combat actions, applied damage, healing, turns, effects, and confirmed outcomes.
